...
import { n as init_clsx, r as require_prop_types, t as clsx } from "./clsx-8UCv8G_V.js";
...
function deepClone(source) {
	if (/*#__PURE__*/ import_react$24.isValidElement(source) || !isPlainObject(source)) return source;
	const output = {};
...
function deepmerge(target, source, options = { clone: true }) {
	...
	if (isPlainObject(target) && isPlainObject(source)) Object.keys(source).forEach((key) => {
		if (/*#__PURE__*/ import_react$24.isValidElement(source[key])) output[key] = source[key];
...
var import_prop_types$9, elementAcceptingRef;
var init_elementAcceptingRef$1 = __esmMin((() => {
	import_prop_types$9 = /* @__PURE__ */ __toESM(require_prop_types());
	init_chainPropTypes();
	elementAcceptingRef = chainPropTypes(import_prop_types$9.default.element, acceptingRef);
...
var import_prop_types$8, elementTypeAcceptingRef_default;
var init_elementTypeAcceptingRef$1 = __esmMin((() => {
	import_prop_types$8 = /* @__PURE__ */ __toESM(require_prop_types());
	init_chainPropTypes();
	elementTypeAcceptingRef_default = chainPropTypes(import_prop_types$8.default.elementType, elementTypeAcceptingRef);
}));
//#endregion
...
function isMuiElement(element, muiNames) {
	...
	return /*#__PURE__*/ import_react$23.isValidElement(element) && muiNames.indexOf((_muiName = element.type.muiName) != null ? _muiName : (_element$type = element.type) == null || (_element$type = _element$type._payload) == null || (_element$type = _element$type.value) == null ? void 0 : _element$type.muiName) !== -1;
}
var import_react$23;
...
var import_react$22, useEnhancedEffect;
var init_useEnhancedEffect$2 = __esmMin((() => {
	import_react$22 = /* @__PURE__ */ __toESM(require_react());
	useEnhancedEffect = typeof window !== "undefined" ? import_react$22.useLayoutEffect : import_react$22.useEffect;
}));
//#endregion
...
function useGlobalId(idOverride) {
	const [defaultId, setDefaultId] = import_react$21.useState(idOverride);
...
var import_react$21, globalId, maybeReactUseId;
var init_useId$2 = __esmMin((() => {
	import_react$21 = /* @__PURE__ */ __toESM(require_react());
	globalId = 0;
	maybeReactUseId = import_react$21["useId".toString()];
}));
//#endregion
...
function useControlled({ controlled, default: defaultProp, name, state = "value" }) {
	const { current: isControlled } = import_react$20.useRef(controlled !== void 0);
	const [valueState, setValue] = import_react$20.useState(defaultProp);
	const value = isControlled ? controlled : valueState;
	{
		...
		const { current: defaultValue } = import_react$20.useRef(defaultProp);
		import_react$20.useEffect(() => {
	...
	return [value, import_react$20.useCallback((newValue) => {
...
function useEventCallback(fn) {
	const ref = import_react$19.useRef(fn);
	useEnhancedEffect(() => {
		ref.current = fn;
	});
	return import_react$19.useRef((...args) => (0, ref.current)(...args)).current;
}
var import_react$19;
...
function useForkRef(...refs) {
	...
	*/
	return import_react$18.useMemo(() => {
...
function useLazyRef(init, initArg) {
	const ref = import_react$17.useRef(UNINITIALIZED);
	if (ref.current === UNINITIALIZED) ref.current = init(initArg);
	return ref;
}
var import_react$17, UNINITIALIZED;
...
function useOnMount(fn) {
	import_react$16.useEffect(fn, EMPTY);
}
var import_react$16, EMPTY;
...
function useIsFocusVisible() {
	const ref = import_react$15.useCallback((node) => {
		if (node != null) prepare(node.ownerDocument);
	}, []);
	const isFocusVisibleRef = import_react$15.useRef(false);
	/**
...
var import_react$15, hadKeyboardEvent, hadFocusVisibleRecently, hadFocusVisibleRecentlyTimeout, inputTypesWhitelist;
...
function getValidReactChildren(children) {
	return import_react$13.Children.toArray(children).filter((child) => /*#__PURE__*/ import_react$13.isValidElement(child));
}
var import_react$13;
...
function useSlotProps(parameters) {
	...
	const { elementType, externalSlotProps, ownerState, skipResolvingSlotProps = false } = parameters, rest = _objectWithoutPropertiesLoose(parameters, _excluded$8);
...
//#endregion
export { duration as $, ClassNameGenerator as $n, isMuiElement as $r, styled$1 as $t, debounce_default as A, _extends as Ai, init_mergeSlotProps as An, useTimeout as Ar, styleFunctionSx as At, init_styled as B, init_isHostComponent$1 as Bn, init_useId$2 as Br, getValue as Bt, ownerWindow_default as C, init_elementAcceptingRef as Ci, init_getReactElementRef$1 as Cn, getScrollbarSize as Cr, init_styleFunctionSx as Ct, isMuiElement_default as D, deepmerge as Di, init_resolveComponentProps as Dn, init_useTimeout as Dr, createTheme$1 as Dt, init_isMuiElement as E, init_deepmerge as Ei, useSlotProps as En, useIsFocusVisible as Er, init_createTheme$1 as Et, SvgIcon as F, require_interopRequireDefault as Fi, init_extractEventHandlers$1 as Fn, useEventCallback as Fr, init_cssGrid as Ft, slotShouldForwardProp as G, clamp as Gn, init_setRef$2 as Gr, init_breakpoints as Gt, init_rootShouldForwardProp as H, _objectWithoutPropertiesLoose as Hn, init_useEnhancedEffect$1 as Hr, getPath as Ht, init_SvgIcon$1 as I, init_appendOwnerState as In, init_useControlled$1 as Ir, init_borders as It, defaultTheme as J, generateUtilityClasses as Jn, ownerWindow as Jr, createBreakpoints as Jt, identifier_default as K, init_clamp$1 as Kn, setRef as Kr, mergeBreakpointsInOrder as Kt, getSvgIconUtilityClass as L, appendOwnerState as Ln, init_useControlled$2 as Lr, createSpacing as Lt, createSvgIcon as M, init_chainPropTypes as Mi, mergeSlotProps as Mn, init_useForkRef$2 as Mr, init_defaultSxConfig as Mt, init_createSvgIcon as N, chainPropTypes as Ni, init_extractEventHandlers as Nn, useForkRef as Nr, init_sizing as Nt, deprecatedPropType_default as O, init_deepmerge$1 as Oi, init_resolveComponentProps$1 as On, Timeout as Or, init_createTheme$2 as Ot, init_SvgIcon as P, init_chainPropTypes$1 as Pi, extractEventHandlers as Pn, init_useEventCallback$2 as Pr, init_palette as Pt, init_createTheme as Q, init_generateUtilityClass$1 as Qn, init_isMuiElement$2 as Qr, internal_serializeStyles as Qt, init_svgIconClasses as R, init_appendOwnerState$1 as Rn, useControlled as Rr, init_createSpacing as Rt, init_ownerWindow as S, init_elementTypeAcceptingRef$1 as Si, getReactElementRef as Sn, init_getScrollbarSize as Sr, init_createMixins as St, ownerDocument_default as T, init_elementAcceptingRef$1 as Ti, init_useSlotProps$1 as Tn, init_useIsFocusVisible$2 as Tr, init_extendSxProp as Tt, rootShouldForwardProp as U, init_objectWithoutPropertiesLoose as Un, init_useEnhancedEffect$2 as Ur, init_style as Ut, styled as V, isHostComponent as Vn, useId as Vr, init_spacing as Vt, init_slotShouldForwardProp as W, init_clamp as Wn, useEnhancedEffect as Wr, handleBreakpoints as Wt, createMuiTheme as X, init_generateUtilityClass as Xn, ownerDocument as Xr, init_styled_engine as Xt, init_defaultTheme as Y, init_generateUtilityClasses$1 as Yn, init_ownerDocument$2 as Yr, init_createBreakpoints as Yt, createTheme as Z, generateUtilityClass as Zn, init_isMuiElement$1 as Zr, internal_processStyles as Zt, useEnhancedEffect_default as _, init_exactProp as _i, init_createChainedFunction as _n, init_usePreviousProps$1 as _r, init_grey as _t, useIsFocusVisible_default as a, capitalize as ai, css as an, init_resolveProps$1 as ar, init_green as at, init_requirePropFactory as b, init_elementTypeAcceptingRef as bi, init_esm as bn, getNormalizedScrollLeft as br, require_colorManipulator as bt, init_useEventCallback as c, init_refType$1 as ci, ThemeContext as cn, init_integerPropType$1 as cr, blue as ct, useControlled_default as d, HTMLElementType as di, init_DefaultPropsProvider$1 as dn, init_visuallyHidden$1 as dr, orange as dt, debounce as ei, styled_engine_exports as en, init_ClassNameGenerator$1 as er, easing as et, init_unsupportedProp as f, init_HTMLElementType$1 as fi, useDefaultProps as fn, visuallyHidden as fr, init_red as ft, init_useEnhancedEffect as g, require_react_is$1 as gi, createChainedFunction_default as gn, init_usePreviousProps as gr, grey as gt, useId_default as h, init_getDisplayName$1 as hi, init_DefaultPropsProvider$3 as hn, init_getValidReactChildren$1 as hr, purple as ht, init_useIsFocusVisible as i, init_capitalize$1 as ii, init_StyledEngineProvider$1 as in, init_resolveProps as ir, green as it, init_debounce as j, init_extends as ji, init_mergeSlotProps$1 as jn, init_useForkRef$1 as jr, defaultSxConfig as jt, init_deprecatedPropType as k, isPlainObject as ki, resolveComponentProps as kn, init_useTimeout$1 as kr, init_styleFunctionSx$1 as kt, useEventCallback_default as l, refType as li, init_emotion_element_489459f2_browser_development_esm as ln, validator as lr, init_blue as lt, init_useId as m, getDisplayName as mi, DefaultPropsProvider$1 as mn, getValidReactChildren as mr, init_purple as mt, unstable_ClassNameGenerator as n, createChainedFunction as ni, init_GlobalStyles$1 as nn, composeClasses as nr, createTypography as nt, init_useForkRef as o, init_capitalize$2 as oi, init_emotion_react_browser_development_esm as on, resolveProps as or, init_lightBlue as ot, unsupportedProp_default as p, init_getDisplayName as pi, init_DefaultPropsProvider$2 as pn, init_getValidReactChildren as pr, red as pt, init_identifier as q, init_generateUtilityClasses as qn, init_ownerWindow$2 as qr, resolveBreakpointValues as qt, utils_exports as r, init_createChainedFunction$2 as ri, StyledEngineProvider as rn, init_composeClasses$1 as rr, init_createTypography as rt, useForkRef_default as s, init_refType as si, keyframes as sn, init_integerPropType as sr, lightBlue as st, init_utils as t, init_debounce$2 as ti, GlobalStyles as tn, init_composeClasses as tr, init_createTransitions as tt, init_useControlled as u, init_HTMLElementType as ui, init_DefaultPropsProvider as un, init_visuallyHidden as ur, init_orange as ut, init_setRef as v, exactProp as vi, capitalize_default as vn, usePreviousProps as vr, common as vt, init_ownerDocument as w, elementAcceptingRef as wi, init_useSlotProps as wn, init_getScrollbarSize$1 as wr, extendSxProp as wt, requirePropFactory_default as x, elementTypeAcceptingRef_default as xi, init_getReactElementRef as xn, init_scrollLeft$1 as xr, createMixins as xt, setRef_default as y, init_exactProp$1 as yi, init_capitalize as yn, detectScrollType as yr, init_common as yt, svgIconClasses as z, init_isHostComponent as zn, init_useId$1 as zr, createUnarySpacing as zt };
